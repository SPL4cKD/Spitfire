...
[h, e, i, w, RAAN, theta] = orbelem(x(2,1+11*3:3+11*3)', dx(1,1+11*3:3+11*3)', mu(4));
orbelemP(h, e, i, w, RAAN, theta )
fprintf('ISS (initial) w/o Planet Perturbations\n')
[h, e, i, w, RAAN, theta] = orbelem(xe(2,4:6)', dxe(1,4:6)', mue(1));
orbelemP(h, e, i, w, RAAN, theta )
fprintf('ISS (final) with Planet Perturbations\n')
[h, e, i, w, RAAN, theta] = orbelem(x(end-1,1+11*3:3+11*3)', dx(end-1,1+11*3:3+11*3)', mu(4));
orbelemP(h, e, i, w, RAAN, theta )
fprintf('ISS (final) w/o Planet Perturbations\n')
[h, e, i, w, RAAN, theta] = orbelem(xe(end-1,4:6)', dxe(end-1,4:6)', mue(1));
orbelemP(h, e, i, w, RAAN, theta )
fprintf('\n\n')

fprintf('___Initial Orbit Parameteres of Chandra___\n')
fprintf('Chandra (initial) with Planet Perturbations\n')
[h, e, i, w, RAAN, theta] = orbelem(x(2,1+12*3:3+12*3)', dx(1,1+12*3:3+12*3)', mu(4));
orbelemP(h, e, i, w, RAAN, theta )
fprintf('Chandra (initial) w/o Planet Perturbations\n')
[h, e, i, w, RAAN, theta] = orbelem(xe(2,7:9)', dxe(1,7:9)', mue(1));
orbelemP(h, e, i, w, RAAN, theta )

fprintf('Chandra (final) with Planet Perturbations\n')
[h, e, i, w, RAAN, theta] = orbelem(x(end-1,1+12*3:3+12*3)', dx(end-1,1+12*3:3+12*3)', mu(4));
orbelemP(h, e, i, w, RAAN, theta )
fprintf('Chandra (final) w/o Planet Perturbations\n')
[h, e, i, w, RAAN, theta] = orbelem(xe(end-1,7:9)', dxe(end-1,7:9)', mue(1));
orbelemP(h, e, i, w, RAAN, theta )
